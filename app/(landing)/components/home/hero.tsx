...
const HeroSection = () => {
    return (
        <section id="hero-section" className="container mx-auto h-screen flex pt-44">
            <div className="relative self-center">
                ...
                <h1 className="font-extrabold text-[95px] -ml-4 italic bg-linear-to-b leading-tight from-black to-[#979797] bg-clip-text text-transparent">
